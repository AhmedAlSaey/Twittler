import { Controller, GetUserTweetsDTO, PostTweetCommentUseCase, HTTPError, HTTPStatusCode } from '../models';
import { makePostTweetCommentController } from './makePostTweetCommentController';

describe('Test controller for posting comments', () => {
	let fakeUseCase: PostTweetCommentUseCase;
	...
	beforeAll(() => {
		...
		controller = jest.fn(makePostTweetCommentController(fakeUseCase));
	});
